...
**0x7v11co** is intended for **educational and authorized testing purposes only**.
...
Developed as an academic graduation project to demonstrate modern vulnerability assessment techniques.
